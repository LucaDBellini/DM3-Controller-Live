...
void handleRoot() {
  ...
  h += "<div class='row'>Kanal 1: " + ch1 + (mute1 ? " <span style='color:var(--danger)'>MUTE</span>" : "") + (level1 != -99999 ? (" — " + String(level1 / 100.0,1) + " dB") : "") + "</div>";
  h += "<div class='row'>Kanal 2: " + ch2 + (mute2 ? " <span style='color:var(--danger)'>MUTE</span>" : "") + (level2 != -99999 ? (" — " + String(level2 / 100.0,1) + " dB") : "") + "</div>";
  h += "</div>";
